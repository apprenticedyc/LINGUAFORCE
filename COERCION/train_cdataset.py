...
from inputters.dataloader_ethics_virtue import get_Ethics_Virtue_loaders
# from inputters.dataloader_suicide import get_SuicideDetection_loaders
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default='inputters/c_data/Ethics/virtue/virtue_train.csv')
    parser.add_argument('--valid_data_path', type=str, default='inputters/c_data/Ethics/virtue/virtue_test.csv')
    # parser.add_argument('--test_data_path', type=str, default='inputters/c_data/Ethics/virtue/virtue_test.csv')
    # parser.add_argument('--train_data_path', type=str, default='inputters/c_data/Suicide_Detection/train.csv')
    # parser.add_argument('--valid_data_path', type=str, default='inputters/c_data/Suicide_Detection/dev.csv')
    # # parser.add_argument('--test_data_path', type=str, default='inputters/c_data/Suicide_Detection/test.csv')
    ...
    _, _, test_loader = get_MoralCoercion_loaders(args, tokenizer)
    train_loader, valid_loader, _ = get_Ethics_Virtue_loaders(args, tokenizer)
    ...
    # 5. 测试阶段
    if args.is_test:
        model.load_state_dict(torch.load(os.path.join(args.save_path, "1_best_mcc_model.pt")))
