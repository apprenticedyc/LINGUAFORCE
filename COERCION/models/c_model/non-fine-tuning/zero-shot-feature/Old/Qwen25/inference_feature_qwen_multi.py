...
base_output_dir = "/root/autodl-tmp/non-fine-tuning/Qwen25/feature_results_multi" # 修改目录名
...
"""
            ...
            with torch.no_grad():
                outputs = model.generate(
                    **inputs,
                    max_new_tokens=5,
                    do_sample=True, # Zero-shot 同样推荐开启采样以利用 Seed 多样性，或者改为 False
                    temperature=0.7,
                    top_p=0.9,
...
# 按二分类 F1 排序 (你也可以改成按 multi f1 排序)
