...
train_data_path = "/root/autodl-tmp/DATA/toxigen_train.csv"  
output_dir = "/root/autodl-tmp/fine-tuning/ToxiGen/binary/Qwen25_LoRA_ToxiGen/" # 建议改个名字区分
...
def format_prompts(example):
    ...
    messages = [
        # System prompt 也相应修改，让模型切换角色
        {"role": "system", "content": "You are a helpful assistant that analyzes text for toxicity and hate speech."},
...
print("[*] Starting ToxiGen LoRA Fine-tuning...")
trainer.train()
