...
# 【修改处】将这里的路径换成你的 ToxiChat jsonl 文件路径
train_data_path = "/root/autodl-tmp/DATA/ToxiChat/train.jsonl"  
output_dir = "/root/autodl-tmp/fine-tuning/ToxiChat/binary/Qwen25_LoRA_ToxiChat/"
    ...
    with open(file_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            def _create_sample(response_dict):
                ...
                # 遵循 ChatML 格式塞入消息
                messages = [
                    {"role": "system", "content": "You are a helpful assistant that detects toxic and offensive language."},
...
print("[*] Starting Transfer Learning on ToxiChat...")
trainer.train()
