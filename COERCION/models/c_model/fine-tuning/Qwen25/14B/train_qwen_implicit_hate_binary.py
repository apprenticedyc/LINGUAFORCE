...
output_dir = "/root/autodl-tmp/fine-tuning/Implicit_Hate/binary/Qwen25_LoRA_ImplicitHate/"
...
def format_prompts(example):
    ...
    # 针对仇恨言论检测重写 Prompt
    prompt_binary = f"Below is a social media post. Please determine whether it contains hate speech (either implicit or explicit). Output 1 if it contains hate speech; output 0 if it does not.\nPost:\n{raw_text}\n\nYour judgment (output only the number 0 or 1):"
...
print("[*] Starting Transfer Learning LoRA Fine-tuning on Implicit Hate...")
trainer.train()
