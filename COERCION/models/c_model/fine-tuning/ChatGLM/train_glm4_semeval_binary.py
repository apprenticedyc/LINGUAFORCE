...
train_data_file = "/root/autodl-tmp/DATA/SemEval-2019_Task5A/train.csv"  # 替换为你的 SemEval CSV 路径
# 输出目录改名，以防覆盖之前的微调权重
output_dir = "/root/autodl-tmp/fine-tuning/SemEval-2019_Task5A/binary/glm4-lora-semeval-binary"
...
# ================= 3. 数据集准备 (适配 SemEval-2019 Task 5A) =================
def load_and_format_semeval(file_path):
    formatted_data = []
    print(f"[*] Reading SemEval data from {file_path}...")
    ...
    for _, row in df.iterrows():
        ...
        # 【核心技巧：Prompt 对齐】
        # 把 SemEval 的单句话伪装成对话的 Utterance 1
        prompt = (
...
train_dataset = load_and_format_semeval(train_data_file)
